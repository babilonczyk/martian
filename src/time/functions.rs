...
mod utc_to_msd_tests {
    ...
    fn test_utc_to_msd_success() {
        ...
        // Allow returning negative msd value
        let date_time = "1800-02-18T00:00:00.000";
        let msd = -26255.70044;
...
pub fn msd_to_utc(msd: f64) -> Result<String, TimeError> {
    ...
    // Leap seconds or 0 if before 1972
    let leap_seconds = tt_epoch.leap_seconds(true).unwrap_or(0.0);
...
mod msd_to_utc_tests {
    ...
    #[test]
    fn test_utc_to_positive_msd_success() {
        let date_time = "2024-11-07T17:58:40.000";
        let msd = 53626.0011;
    ...
    #[test]
    fn test_utc_to_negative_msd_success() {
        let date_time = "1800-02-18T00:00:00.000";
        let msd = -26255.70044;
        let result = msd_to_utc(msd).unwrap();
